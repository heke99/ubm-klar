    ...
    fields: [
      {
        ...
        title: 'Personnummer',
        dataType: 'personal_identity_number',
        required: true,
        dataClass: 'personal_data',
      },
      {
        fieldKey: 'decision_number',
        title: 'Beslutsnummer',
        dataType: 'string',
        required: true,
        maxLength: 64,
      ...
      {
        fieldKey: 'insats_kind',
        title: 'Insats',
        dataType: 'code',
        required: true,
        codeListKey: 'lss_insats',
      },
      {
        fieldKey: 'decision_period_start',
        title: 'Beslutsperiod start',
        dataType: 'date',
        required: true,
      },
      {
        fieldKey: 'decision_period_end',
        title: 'Beslutsperiod slut',
        dataType: 'date',
        required: false,
      },
      {
      ...
      {
        fieldKey: 'paid_amount_sek',
        title: 'Utbetalt belopp (SEK)',
        dataType: 'amount_sek',
        required: false,
        dataClass: 'income_data',
      },
      {
        fieldKey: 'provider_org_number',
        title: 'Utförarens organisationsnummer',
        dataType: 'org_number',
        required: false,
      },
      {
        fieldKey: 'document_reference',
        title: 'Dokumentreferens',
        dataType: 'string',
        required: false,
        maxLength: 128,
      },
